...
Examples:
    ...
    # Undo with preview
    mww-cluster-apply --undo cluster_output/positive_backup_manifest.json --dry-run
        """,
    )
    ...
    if args.dry_run:
        ...
        console.print(
            Panel(
                ...
                "To undo, run:\n"
                f"  [bold]mww-cluster-apply --undo {output_dir}/<dataset>_backup_manifest.json[/bold]",
                title="Done",
                border_style="green",
            )
        )
