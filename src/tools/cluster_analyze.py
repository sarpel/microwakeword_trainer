...
def main() -> None:
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python cluster_analyze.py --config standard
    python cluster_analyze.py --config standard --dataset all
    python cluster_analyze.py --config standard --n-clusters 200
    python cluster_analyze.py --config standard --override my_config.yaml
...
Output files (per dataset):
    ...
    if args.threshold is not None and args.n_clusters is not None:
        console.print("[yellow]Warning: both --threshold and --n-clusters provided; --n-clusters takes precedence.[/yellow]")
    ...
    from ..data.clustering import SpeakerClustering
