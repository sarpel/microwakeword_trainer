...
│   ├── max_quality.yaml
│   └── fast_test.yaml
└── loader.py          # ConfigLoader class (625 lines)
```

## ConfigLoader (`loader.py`)
Heavyweight config system supporting:
- **Dataclass validation**: 9 config sections (Hardware, Paths, Training, Model, etc.)
...
## Notes
- Loader is 625 lines - complex but feature-complete
